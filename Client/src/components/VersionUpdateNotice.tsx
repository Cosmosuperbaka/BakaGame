    ...
    <AnimatePresence>
      {active && updateAvailable && (
        <motion.div
          ...
          className="fixed bottom-[max(1.25rem,env(safe-area-inset-bottom,1.25rem))] left-1/2 z-[110] flex w-[calc(100%-2rem)] max-w-md -translate-x-1/2 items-center gap-3 rounded-xl border border-border bg-card/95 px-4 py-3 text-card-foreground shadow-lg backdrop-blur-md"
        >
